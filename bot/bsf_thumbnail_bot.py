...
----------------------------------------------
Polls the BIG Sci-Fi YouTube channel RSS feed, detects new videos,
slugifies the title, fetches the matching image from GitHub,
and uploads it as the YouTube custom thumbnail.

Runs every Tuesday; state is persisted in state/bsf_last_seen.json
...
YOUTUBE_CHANNEL_ID     = os.environ.get("YOUTUBE_CHANNEL_ID", "UCZKA28djGLuv8FvstRrXQyw")
